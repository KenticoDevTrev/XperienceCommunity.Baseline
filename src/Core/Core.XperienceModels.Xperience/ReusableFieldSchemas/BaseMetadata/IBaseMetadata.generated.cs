...
namespace Generic
{
    ...
    /// </summary>
    public interface IBaseMetadata : IBaseMetadataCore, IWebPageFieldsSource
    {
	...
	/// Defines a contract for content types with the <see cref="IBaseMetadata"/> reusable schema assigned.
	/// </summary>
	public interface IBaseMetadataResuableContent : IBaseMetadataCore, IContentItemFieldsSource
    {

    }

    public interface IBaseMetadataCore
	{
        /// <summary>
