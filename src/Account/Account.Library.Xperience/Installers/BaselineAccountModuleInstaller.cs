...
{
    public class BaselineAccountModuleInstaller(BaselineAccountOptions baselineAccountOptions,
        IEventLogService eventLogService,
        IInfoProvider<ContentTypeChannelInfo> contentTypeChannelInfoProvider,
        IInfoProvider<ChannelInfo> channelInfoProvider)
    {
        private readonly BaselineAccountOptions _baselineAccountOptions = baselineAccountOptions;
        ...
        public void Install()
        {
            if (_baselineAccountOptions.UseAccountWebpageType) {
                CreateAccountWebpage();
            }
            InstallationRan = true;
        }

        private void CreateAccountWebpage()
        {
